...
def register():
    ...
    if existing_user:
        ...
        messagebox.showerror(
            "Registration Failed", "Username cannot be empty or contain only spaces."
        )
...
# Thiết lập hình nền
background_image = tk.PhotoImage(file="resources/images/Game_Loop_Background.png")
...
button_auth = tk.Button(root, text="Login", command=login, highlightthickness=0)
...
button_auth.config(
    font=("Helvetica", 8, "bold"), width=10, height=3, borderwidth=2, relief="solid"
)
button_toggle.config(
