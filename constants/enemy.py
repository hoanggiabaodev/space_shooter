...
if random.choice([True, False]):
    # Chọn cạnh trái
    ENEMY_START_X = random.randint(0, SCREEN_WIDTH // 2)
else:
    # Chọn cạnh phải
    ENEMY_START_X = random.randint(SCREEN_WIDTH // 2, SCREEN_WIDTH)

ENEMY_START_Y = random.randint(50, 200)

# ENEMY_START_X = random.randint(0, SCREEN_WIDTH)
ENEMY_START_Y = random.randint(50, SCREEN_HEIGHT - 200)
...
ENEMY_LEVEL_2_HEALTH = 28
ENEMY_LEVEL_3_HEALTH = 34
ENEMY_LEVEL_4_HEALTH = 42
ENEMY_LEVEL_5_HEALTH = 47
...
ENEMY_LEVEL_1_FREQUENCY_RATE = 0.4
ENEMY_LEVEL_2_FREQUENCY_RATE = 0.25
ENEMY_LEVEL_3_FREQUENCY_RATE = 0.15
ENEMY_LEVEL_4_FREQUENCY_RATE = 0.1
ENEMY_LEVEL_5_FREQUENCY_RATE = 0.1

ENEMY_GENETATE_DELAY = 1
